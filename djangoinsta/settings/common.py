"""
Django settings for djangoinsta project.
...
SECRET_KEY = '#g=79e+x#fl40_p36lawul@i+h9q&!nen#ak7*gd=$w@+*5=!l'
...
ROOT_URLCONF = 'djangoinsta.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, 'djangoinsta', 'templates')
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'djangoinsta.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'djangoinsta', 'static')
]
